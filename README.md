...
После того как вы добавили репозиторий к себе, вы можете начать работу с ним (**Фиксируйте все новые изменения в новой ветке Git**). Если вы хотите отправить свои изменения автору репозитория используйте, так называемый pull request. Для этого, необходимо, закоммитить все изменения, отправить их в удалённый репозиторий, перейти на сайт GitHub, открыть наш удалённый репозиторый и зайти во вкладку Pull requests. Далее жмём зелёную кнопку New pull request, выбираем нашу ветку с изменениями и отправляем автору.